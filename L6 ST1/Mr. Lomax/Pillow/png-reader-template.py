...
def read_png_chunks(filename):
    with open(filename, 'rb') as png_file:
        ...
        while True:
            ...
            chunk_type = png_file.read(4).decode('utf-8')
            ...
            # Check crc
            crc_check = binascii.crc32(chunk_type.encode('utf-8')+chunk_data)
            if crc_check != crc:
...
read_png_chunks('L6 ST1\Mr. Lomax\Pillow\landscape.png')